    ...
    <>
      <div>
          <div className="relative md:ml-16 ml-0">
            <div className="z-0 mt-16 mb-20 font-bold ml-16 md:ml-0"><h1 className="font-poppins font-bold inline sm:text-[100px] text-[55px]">Investing In Your</h1><h1 className="font-poppins font-bold inline text-blue-800 sm:text-[100px] text-[55px]"> Future</h1></div>
            <section className="">
            ...
            <div className='mt-32'>
              ...
              <div className="flex flex-wrap flex-row text-[20px] justify-center text-center text-white mx-3 sm:mx-0">
                <div className="flex flex-col flex-wrap w-[350px] mr-1 mb-1">
                  <div className="bg-gradient-to-tr from-blue-700 to-blue-800 py-10 rounded-md mb-1">Healthcare & Medical</div>
                ...
                <div className="flex flex-col flex-wrap w-[350px] mr-1 mb-1">
                  ...
                  <div className="bg-gradient-to-tr from-blue-700 to-blue-800 py-10 rounded-md mb-1">Hello 10</div>
                  <div className="bg-gradient-to-tr from-blue-700 to-blue-800 py-10 rounded-md mb-1">Hello 11</div>
                  <div className="bg-gradient-to-tr from-blue-700 to-blue-800 py-10 rounded-md">Hello 12</div>
                </div>
                ...
                <div className="flex flex-col flex-wrap w-[350px] mr-1 mb-1">
                  ...
                  <div className="bg-gradient-to-tr from-blue-700 to-blue-800 py-10 rounded-md mb-1">Tech</div>
